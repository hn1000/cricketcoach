...
const page = usePage();
const company = page.props.company.data || page.props.company;
    ...
    <AdminLayout>
        <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full mb-1">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Edit Company</h1>
            </div>
        </div>
            ...
            <form @submit.prevent="submit">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        >
                        <div v-if="form.errors.website" class="text-sm text-red-600 mt-1">{{ form.errors.website }}</div>
                    </div>
