...
const submit = () => {
    form.post(route('admin.companies.staff.store', props.company.id));
};
</script>

<template>
    <Head :title="`Add Staff - ${company.name}`" />
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-500 md:ml-2 dark:text-gray-400">Add Staff</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Add Staff Member</h1>
            </div>
        </div>
